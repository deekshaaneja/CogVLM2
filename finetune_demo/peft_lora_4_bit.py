...
def main():
    ...
    parser.add_argument("--save_step", type=int, default=10, help="Steps between checkpoints")
    ...
    parser.add_argument("--max_input_len", type=int, default=16, help="Maximum input length")
    parser.add_argument("--max_output_len", type=int, default=16, help="Maximum output length")
    parser.add_argument("--model_path", type=str,
                        default="THUDM/cogvlm2-llama3-chat-19B-int4",
